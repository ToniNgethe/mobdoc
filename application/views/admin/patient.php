...
<html lang="en">
    <head>
        ...
        <title> Admin :: Patient - Mobdoc</title>
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="list-group">
                        ...
                        <a href="<?= base_url('admin/patient'); ?>" class="list-group-item active">Patient</a>
                ...
                <div class="col-md-9" id="rev">
                    ...
                    <div class="page-header">
                        <h1 class="hidden-sm hidden-xs"><i class="i i-users3"></i> Registered patients</h1>
                    </div>
